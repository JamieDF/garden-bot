...
DEFAULT_LAYOUT = [
    {"i": "bot", "type": "bot", "x": 0, "y": 0, "w": 8, "h": 2, "config": {}},
    {"i": "cam", "type": "camera", "x": 8, "y": 0, "w": 4, "h": 2,
     "config": {"device": "tent_cam"}},
    {"i": "m1", "type": "metric", "x": 0, "y": 2, "w": 3, "h": 1,
     "config": {"sensor": "inside_air.temperature"}},
    {"i": "m2", "type": "metric", "x": 3, "y": 2, "w": 3, "h": 1,
     "config": {"sensor": "outside_air.temperature"}},
    {"i": "m3", "type": "metric", "x": 6, "y": 2, "w": 3, "h": 1,
     "config": {"sensor": "inside_climate.humidity"}},
    {"i": "m4", "type": "metric", "x": 9, "y": 2, "w": 3, "h": 1,
     "config": {"sensor": "inside_climate.pressure"}},
    {"i": "chart", "type": "chart", "x": 0, "y": 3, "w": 8, "h": 4,
     "config": {}},
    {"i": "fan", "type": "fan", "x": 8, "y": 3, "w": 4, "h": 4,
     "config": {"device": "circulation"}},
    {"i": "journal", "type": "journal", "x": 0, "y": 7, "w": 12, "h": 3,
     "config": {}},
]
